      ...
      <section className="h-full flex items-center justify-center text-center p-6 pt-16 font-mono tracking-tight">
        <div className="flex flex-col md:flex-row items-center gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div
              className="absolute -top-2 -right-2 w-14 h-14 bg-dark-100 rounded-full flex items-center justify-center shadow-lg border border-slate-700"
          ...
          <div className="text-center md:text-left max-w-lg">
            ...
            <motion.p
              className="text-lg md:text-xl text-slate-300 mt-3"
              {...fadeInUp}
            ...
            <motion.p
              className="text-sm md:text-base text-slate-400 mt-4 max-w-md"
              {...fadeInUp}
